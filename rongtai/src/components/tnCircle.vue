    ...
    <svg viewBox="0 0 100 100">
      <defs v-if="isGradient">
        <linearGradient :id='id' x1="10%" y1="45%" x2="50%" y2="0%">
          <stop :style="{'stop-color': strokeColor[0], 'stop-opacity': 1}" offset="0%" />
          <stop :style="{'stop-color': strokeColor[1], 'stop-opacity': 1}" offset="100%" />
        </linearGradient>
      </defs>
      <path
        :d="pathString"
      ...
      <path
        ...
        :stroke="isGradient ? `url(#${id})`: strokeColor"
